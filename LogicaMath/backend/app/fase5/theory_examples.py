        ...
        (1, 1): [
            {
                "enunciado": "Calcula el perímetro de esta figura contando cada segmento del contorno en la cuadrícula:<br/>"
                             "<svg width='120' height='120' viewBox='0 0 120 120' style='margin:10px auto; display:block; background:#111827; border:1px solid #374151; border-radius:10px;'>"
                             "  <!-- Grilla -->"
                             ...
                             "  <!-- Polígono -->"
                             "  <rect x='40' y='40' width='40' height='40' fill='#A855F7' fill-opacity='0.2' stroke='#A855F7' stroke-width='3'/>"
                             "  <text x='60' y='65' fill='#A855F7' font-weight='bold' text-anchor='middle'>2x2</text>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Un rectángulo tiene lados de 3 y 4 unidades. ¿Cuál es su perímetro?",
                "pasos": [
                    {"orden": 1, "texto": "Un rectángulo tiene 4 lados. Lados paralelos son iguales."},
                    {"orden": 2, "texto": "Los lados miden: 3, 4, 3, y 4 unidades."},
                    {"orden": 3, "texto": "Sumamos todo el contorno: 3 + 4 + 3 + 4 = <span class=\"keyword-highlight\">14 unidades</span>."}
                ]
            },
            {
                "enunciado": "Un cuadrado tiene un lado de 5 unidades. ¿Cuál es su perímetro?",
                "pasos": [
            ...
            {
                "enunciado": "El perímetro de un triángulo con lados de 6 unidades cada uno es:",
                "pasos": [
                    {"orden": 1, "texto": "Este es un triángulo equilátero porque todos sus lados miden igual."},
                    {"orden": 2, "texto": "Tiene 3 lados, así que sumamos: 6 + 6 + 6."},
        ...
        (1, 2): [
            {
                "enunciado": "Calcula el perímetro de esta figura irregular sumando las longitudes de sus lados:<br/>"
                             ...
                             "  <polygon points='20,20 120,20 120,80 80,80 80,50 20,50' fill='#F59E0B' fill-opacity='0.2' stroke='#F59E0B' stroke-width='2.5'/>"
                             "  <text x='70' y='15' fill='#FFF' font-size='8' text-anchor='middle'>10 cm</text>"
                             "  <text x='128' y='55' fill='#FFF' font-size='8' text-anchor='middle'>6 cm</text>"
                             "  <text x='100' y='92' fill='#FFF' font-size='8' text-anchor='middle'>4 cm</text>"
                             "  <text x='70' y='65' fill='#FFF' font-size='8' text-anchor='middle'>3 cm</text>"
                             "  <text x='50' y='45' fill='#FFF' font-size='8' text-anchor='middle'>6 cm</text>"
                             "  <text x='10' y='40' fill='#FFF' font-size='8' text-anchor='middle'>3 cm</text>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Una figura tiene lados de 2, 3, 2 y 3. ¿Cuál es su perímetro?",
                "pasos": [
            ...
            {
                "enunciado": "Una estrella geométrica tiene 5 lados iguales y cada uno mide 1 cm. ¿Cuál es el perímetro?",
                "pasos": [
                    {"orden": 1, "texto": "Sumamos la longitud de cada una de las 5 puntas de 1 cm."},
                    {"orden": 2, "texto": "Suma: 1 + 1 + 1 + 1 + 1 = 5."},
                    {"orden": 3, "texto": "Perímetro total: <span class=\"keyword-highlight\">5 cm</span>."}
                ]
            },
            {
                "enunciado": "Calcula el contorno de un rectángulo con lados de 10, 5, 10 y 5 cm.",
                "pasos": [
        ...
        (1, 3): [
            {
                "enunciado": "¿Cómo convertimos 2 metros (m) a centímetros (cm)?<br/>"
                             ...
                             "  <rect x='10' y='5' width='140' height='20' fill='#10B981' rx='4'/>"
                             "  <text x='80' y='18' fill='#FFF' font-size='10' font-weight='bold' text-anchor='middle'>1 m = 100 cm</text>"
                             "  <text x='80' y='36' fill='#6B7280' font-size='8' text-anchor='middle'>Multiplicamos por 100</text>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "¿Cuántos centímetros hay en 3 metros?",
                "pasos": [
            ...
            {
                "enunciado": "¿Cuántos metros hay en 5 kilómetros (km)?",
                "pasos": [
                    {"orden": 1, "texto": "Un kilómetro es muy largo. ¡Tiene 1000 metros!"},
            ...
            {
                "enunciado": "¿Cuántos milímetros (mm) hay en 2 centímetros (cm)?",
                "pasos": [
        ...
        (2, 1): [
            {
                "enunciado": "Calcula el área contando los cuadrados completos ocupados por el rectángulo:<br/>"
                             ...
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#374151' stroke-width='0.5'/>"
                             "  <!-- Rectángulo de 2x3 -->"
                             "  <rect x='40' y='20' width='40' height='60' fill='#EC4899' fill-opacity='0.3' stroke='#EC4899' stroke-width='2.5'/>"
                             "  <text x='60' y='55' fill='#FFF' font-size='10' font-weight='bold' text-anchor='middle'>Área = 6</text>"
                             "</svg>",
                "pasos": [
                    {"orden": 1, "texto": "El área mide el <span class=\"keyword-highlight\">espacio de adentro</span> en cuadraditos."},
            ...
            {
                "enunciado": "¿Cuál es el área de un cuadrado de 4x4 unidades?",
                "pasos": [
                    {"orden": 1, "texto": "Un cuadrado de 4x4 tiene 4 filas de 4 cuadraditos cada una."},
                    {"orden": 2, "texto": "Multiplicamos lado por lado: 4 × 4 = 16."},
                    {"orden": 3, "texto": "El área total es: <span class=\"keyword-highlight\">16</span>."}
                ]
            },
            {
                "enunciado": "Un rectángulo mide 5 de base y 2 de altura. Su área es:",
                "pasos": [
                    {"orden": 1, "texto": "El área de un rectángulo es Base × Altura."},
                    {"orden": 2, "texto": "Multiplicamos los lados: 5 × 2 = 10."},
                    {"orden": 3, "texto": "Resultado: <span class=\"keyword-highlight\">10 unidades cuadradas</span>."}
                ]
            },
            {
                "enunciado": "Si pintas 3 filas con 3 cuadros cada una en un papel cuadriculado, ¿cuánto mide el área pintada?",
                "pasos": [
        ...
        (2, 2): [
            {
                "enunciado": "Calcula el área total de la figura sumando cuadrados completos y mitades (triángulos):<br/>"
                             ...
                             "  <rect x='40' y='40' width='40' height='20' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='2'/>"
                             "  <polygon points='80,40 100,40 80,60' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.5'/>"
                             "  <polygon points='80,60 100,60 80,40' fill='#3B82F6' fill-opacity='0.1' stroke='#3B82F6' stroke-width='1.5'/>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Si tengo 4 cuadrados enteros y 2 mitades. ¿Cuál es el área total?",
                "pasos": [
            ...
            {
                "enunciado": "Una figura geométrica tiene 0 cuadrados enteros y 4 mitades triangulares. Su área es:",
                "pasos": [
            ...
            {
                "enunciado": "Si tengo 10 enteros y 6 mitades, ¿cuál es el área total?",
                "pasos": [
        ...
        (2, 3): [
            {
                "enunciado": "Suma el área de esta figura irregular en la cuadrícula:<br/>"
                             ...
                             "  <rect x='40' y='40' width='40' height='40' fill='#10B981' fill-opacity='0.3' stroke='#10B981' stroke-width='2'/>"
            ...
            {
                "enunciado": "¿Cuánto es 8 enteros más 8 mitades?",
                "pasos": [
            ...
            {
                "enunciado": "¿Cuánto es 12 enteros más 2 mitades?",
                "pasos": [
            ...
            {
                "enunciado": "Si un polígono ocupa 5 enteros y 4 mitades, su área es:",
                "pasos": [
        ...
        (3, 1): [
            {
                "enunciado": "Calcula el área total de esta figura en 'L' descomponiéndola en dos rectángulos independientes:<br/>"
                             ...
                             "  <rect x='20' y='10' width='30' height='70' fill='#A855F7' fill-opacity='0.3' stroke='#A855F7' stroke-width='2'/>"
                             "  <!-- Rectángulo B (horizontal) -->"
                             "  <rect x='50' y='50' width='50' height='30' fill='#06B6D4' fill-opacity='0.3' stroke='#06B6D4' stroke-width='2'/>"
                             "  <text x='35' y='45' fill='#A855F7' font-weight='bold' font-size='10'>A</text>"
                             "  <text x='75' y='70' fill='#06B6D4' font-weight='bold' font-size='10'>B</text>"
                             "</svg>",
                "pasos": [
                    {"orden": 1, "texto": "Descomponemos la figura 'L' en dos rectángulos que no se encimen: el A y el B."},
            ...
            {
                "enunciado": "Un rectángulo de 10 u² y otro de 8 u² pegados. ¿Cuánto suman en total?",
                "pasos": [
            ...
            {
                "enunciado": "Una figura en 'T' está compuesta por una barra de techo de 12 u² y una base de 4 u². Su área es:",
                "pasos": [
            ...
            {
                "enunciado": "Una figura 'L' tiene una torre de 15 u² y un pie de 5 u². ¿Cuál es su área total?",
                "pasos": [
        ...
        (3, 2): [
            {
                "enunciado": "Si cortamos una hoja de papel de 10 cm² en varios pedazos para armar un barco con Tangram, ¿cuál es el área total del barco?<br/>"
                             "<svg width='120' height='80' viewBox='0 0 120 80' style='margin:10px auto; display:block;'>"
                             "  <!-- Silueta de barco simple -->"
                             "  <polygon points='30,50 90,50 80,70 40,70' fill='#F59E0B' stroke='#B45309' stroke-width='1.5'/>"
                             "  <polygon points='60,15 60,45 85,45' fill='#EC4899' stroke='#BE185D' stroke-width='1.5'/>"
                             "  <polygon points='55,20 55,45 35,45' fill='#3B82F6' stroke='#1D4ED8' stroke-width='1.5'/>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Si un triángulo de 3 u² se rota o gira, ¿cuál es su nueva área?",
                "pasos": [
            ...
            {
                "enunciado": "Corto un papel de 10 u² en dos. ¿Cuánto sumará el área de ambas piezas juntas?",
                "pasos": [
            ...
            {
                "enunciado": "Armo una casa de juguete usando todas las piezas de un Tangram de 16 u². El área de la casa es:",
                "pasos": [
        ...
        (3, 3): [
            {
                "enunciado": "Calcula el área sombreada (la zona de color violeta) restando el área del hueco en blanco:<br/>"
                             "<svg width='120' height='100' viewBox='0 0 120 100' style='margin:10px auto; display:block; border:1px solid #4B5563; background:#1F2937;'>"
                             "  <!-- Rectángulo exterior -->"
                             "  <rect x='10' y='10' width='100' height='80' fill='#8B5CF6' fill-opacity='0.4' stroke='#8B5CF6' stroke-width='2'/>"
                             "  <!-- Hueco interior -->"
                             "  <rect x='40' y='30' width='40' height='40' fill='#1F2937' stroke='#9CA3AF' stroke-dasharray='3'/>"
                             "  <text x='25' y='55' fill='#8B5CF6' font-weight='bold' font-size='8'>Pintado</text>"
                             "  <text x='60' y='55' fill='#FFF' font-size='8' text-anchor='middle'>Hueco</text>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Si el área exterior de un cartel es 50 cm² y tiene una foto en blanco de 10 cm² adentro, ¿cuál es el área sombreada?",
                "pasos": [
            ...
            {
                "enunciado": "Una caja de cartón de 100 cm² tiene una ventana transparente de 25 cm². ¿Cuánto mide el área de cartón restante?",
                "pasos": [
            ...
            {
                "enunciado": "Una pared de 20 u² tiene una ventana de 4 u². ¿Cuál es el área de pared que se va a pintar?",
                "pasos": [
        ...
        (3, 4): [
            {
                "enunciado": "¿Cuántos ejes de simetría tiene un cuadrado perfecto?<br/>"
                             "<svg width='100' height='100' viewBox='0 0 100 100' style='margin:10px auto; display:block; border:2px solid #3B82F6; background:#1F2937;'>"
                             "  <!-- Líneas de simetría -->"
                             "  <line x1='50' y1='0' x2='50' y2='100' stroke='#EF4444' stroke-width='1.5' stroke-dasharray='4'/>"
                             "  <line x1='0' y1='50' x2='100' y2='50' stroke='#EF4444' stroke-width='1.5' stroke-dasharray='4'/>"
                             "  <line x1='0' y1='0' x2='100' y2='100' stroke='#10B981' stroke-width='1.5' stroke-dasharray='4'/>"
                             "  <line x1='100' y1='0' x2='0' y2='100' stroke='#10B981' stroke-width='1.5' stroke-dasharray='4'/>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "¿Cuántos ejes de simetría tiene un triángulo equilátero (3 lados iguales)?",
                "pasos": [
            ...
            {
                "enunciado": "¿Tiene ejes de simetría una figura con forma de letra 'F'?",
                "pasos": [
                    {"orden": 1, "texto": "Intentamos trazar una línea vertical u horizontal que actúe de espejo."},
                    {"orden": 2, "texto": "Al doblarla de cualquier lado, los brazos de la 'F' no coinciden."},
        ...
        (4, 1): [
            {
                "enunciado": "En un plano de escala gráfica, 1 unidad del mapa equivale a 10 metros reales. ¿Cuántos metros representan 4 unidades?<br/>"
                             "<svg width='160' height='50' viewBox='0 0 160 50' style='margin:10px auto; display:block; background:#1F2937; border-radius:8px; border:1px solid #4B5563;'>"
                             ...
                             "  <text x='10' y='40' fill='#FFF' font-size='8'>0m</text>"
                             "  <text x='40' y='40' fill='#FFF' font-size='8'>10m</text>"
                             "  <text x='70' y='40' fill='#FFF' font-size='8'>20m</text>"
                             "  <text x='100' y='40' fill='#FFF' font-size='8'>30m</text>"
                             "  <text x='130' y='40' fill='#FFF' font-size='8'>40m</text>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Si la escala es 1 u = 5 km, y viajas una distancia de 6 u en el mapa, ¿cuál es la distancia real?",
                "pasos": [
            ...
            {
                "enunciado": "Escala 1 u = 2 m. Un árbol mide 15 u de altura en el plano. ¿Cuál es su altura real?",
                "pasos": [
            ...
            {
                "enunciado": "En un mapa de escala 1 u = 100 m, una calle mide 3 u. ¿Cuánto mide en la realidad?",
                "pasos": [
        ...
        (4, 2): [
            {
                "enunciado": "Un monitor de computadora se anuncia como de 25 pulgadas. ¿Qué parte física mide 25 pulgadas?<br/>"
                             "<svg width='120' height='100' viewBox='0 0 120 100' style='margin:10px auto; display:block;'>"
                             "  <rect x='10' y='10' width='100' height='70' fill='#374151' rx='5' stroke='#FFF' stroke-width='2'/>"
                             "  <!-- Diagonal -->"
                             "  <line x1='10' y1='80' x2='110' y2='10' stroke='#EF4444' stroke-width='3' stroke-dasharray='4'/>"
                             "  <text x='65' y='55' fill='#EF4444' font-weight='bold' font-size='10' transform='rotate(-32 65 55)'>Diagonal</text>"
            ...
            {
                "enunciado": "En un rectángulo que mide 3 de base y 4 de altura, ¿cuánto mide la diagonal?",
                "pasos": [
            ...
            {
                "enunciado": "¿Qué medida es más larga en un televisor, su base horizontal o su diagonal inclinada?",
                "pasos": [
            ...
            {
                "enunciado": "Si un televisor se describe como de 50 pulgadas, ¿dónde se toman esas 50 pulgadas?",
                "pasos": [
        ...
        (4, 3): [
            {
                "enunciado": "¿Cuántos centímetros cuadrados (cm²) hay en 1 metro cuadrado (m²)?<br/>"
                             "<svg width='120' height='120' viewBox='0 0 120 120' style='margin:10px auto; display:block; border:2px solid #10B981; background:#1F2937;'>"
                             "  <text x='60' y='45' fill='#FFF' font-size='10' font-weight='bold' text-anchor='middle'>1 m²</text>"
                             "  <text x='60' y='65' fill='#10B981' font-size='10' font-weight='bold' text-anchor='middle'>= 10,000 cm²</text>"
                             "  <text x='60' y='85' fill='#6B7280' font-size='8' text-anchor='middle'>100cm x 100cm</text>"
                             "</svg>",
                "pasos": [
            ...
            {
                "enunciado": "Si 1 decímetro (dm) = 10 cm, ¿cuántos cm² hay en 1 dm²?",
                "pasos": [
            ...
            {
                "enunciado": "Si 1 m = 10 dm, ¿cuántos dm² hay en 2 m²?",
                "pasos": [
            ...
            {
                "enunciado": "Si un azulejo mide 2 m² y lo queremos pasar a centímetros cuadrados, ¿cuánto resulta?",
                "pasos": [
