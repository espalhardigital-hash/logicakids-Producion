...
const AdminPanel: React.FC<Props> = ({ onBack }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-gray-950 to-black text-white overflow-y-auto w-full h-full custom-scrollbar">
      ...
      <div className="fixed top-[20%] right-[10%] w-[300px] h-[300px] bg-amber-500/5 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="w-full flex justify-between items-center mb-10">
          <div className="flex items-center gap-6">
            <button
              onClick={onBack}
              className="p-3.5 hover:bg-white/10 rounded-2xl transition-all bg-white/5 border border-white/10 shadow-xl group"
            >
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm font-medium mt-1">Gestión avanzada • <span className="text-blue-400">LogicaKids Pro</span></p>
            </div>
          </div>
        </motion.div>
