              ...
              >
                ...
                {pregunta.tipo_pregunta === 'respuesta_numerica' && (
                  <div className="flex flex-col h-full justify-between">
                    <div className="f5-question-text-box"><div className={(pregunta.enunciado || '').length < 25 ? "f5-question-text short" : "f5-question-text"} dangerouslySetInnerHTML={{ __html: pregunta.enunciado }} /></div>
