...
const WelcomeScreenPhase2: React.FC<Props> = ({
  ...
  const loadDashboard = useCallback(async () => {
    try {
      ...
      console.warn('[Fase5] Backend no disponible, usando datos de muestra.', e);
    } finally {
      setLoading(false);
    }
          ...
          <div className="f5-header-profile">
            ...
            <div className="f5-header-user-info">
              ...
              <div className="f5-header-subtitle">
                <span className="f5-badge-fase">FASE 2</span>
                <span className="f5-header-fasename">Desarrollo Numérico y Razonamiento</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="f5-content">
        {!selectedModule ? (
          <>
            ...
            <div
              className={`f5-challenge-banner ${dashboard.desafio_mixto_disponible ? '' : 'bloqueado'}`}
            >
...
function MOCK_DASHBOARD(nombre: string): Fase5Dashboard {
