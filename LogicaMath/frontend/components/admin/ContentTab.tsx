  ...
  return (
    <div className="w-full flex flex-col gap-6 text-white select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        {/* Right Column: Questions Table & Theory Form */}
          ...
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-6 rounded-[2.2rem] shadow-2xl flex flex-col gap-5">
            <div className="flex justify-between items-center border-b border-white/5 pb-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-sm font-black flex items-center gap-1.5 shadow-md shadow-blue-900/10 active:scale-95 transition-all cursor-pointer"
              >
                <Plus size={14} />
                Agregar Pregunta
              </button>
