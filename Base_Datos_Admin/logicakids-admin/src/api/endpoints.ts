export const ENDPOINTS = {
  ...
  ADMIN_USERS: { LIST_OR_SAVE: "/users", DELETE: (id: string) => `/users/${id}`, CREATE: "/admin/users", CHANGE_PASSWORD: (id: string) => `/admin/users/${id}/password`, ANONYMIZE: (id: string) => `/admin/users/${id}/forget`, BULK_DELETE: "/admin/users/bulk" },
