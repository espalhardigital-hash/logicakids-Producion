...
src_path = "questions_dump.sql"
dest_path = "final_migration.sql"
    ...
    with open(dest_path, "w", encoding="utf-8") as dest:
        ...
        with open(src_path, "r", encoding="utf-16") as src:
            while True:
                ...
                dest.write(chunk)
        dest.write(footer)
    print("✅ final_migration.sql created successfully (with UTF-16 to UTF-8 conversion).")
    ...
    with open(dest_path, "w", encoding="utf-8") as dest:
        ...
        with open(src_path, "r", encoding="utf-8") as src:
            while True:
                ...
                dest.write(chunk)
        dest.write(footer)
    print("✅ final_migration.sql created successfully (with UTF-8).")
