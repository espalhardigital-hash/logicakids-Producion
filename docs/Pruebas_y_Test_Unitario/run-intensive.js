...
try {
  ...
  const testsToRun = [
    'tests/03-gameplay-fase1.spec.ts',
    'tests/06-gameplay-fase2.spec.ts',
    'tests/07-gameplay-fase3.spec.ts',
    'tests/08-gameplay-fase4.spec.ts',
    'tests/09-gameplay-fase5.spec.ts',
    'tests/10-gameplay-fase6.spec.ts',
    'tests/11-gameplay-fase7-8.spec.ts',
    'tests/12-gameplay-fase9.spec.ts',
    'tests/13-admin-panel.spec.ts' // Validamos admin al final
  ];
