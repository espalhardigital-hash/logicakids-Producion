...
- Name: 06-gameplay-fase2.spec.ts >> 06 - Gameplay Fase 2 (Aritmética Intermedia) - Exhaustivo >> Módulo 1 Desafío 1011 - Salida Temprana
...
Call log:
  - waiting for locator('button:has-text("48")').first()
    - locator resolved to <button class="f2-mc-option-btn ">48</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="f2-splash-countdown-number">7</div> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <circle r="45" cx="50" cy="50" pathLength="1" stroke-dashoffset="0" stroke-dasharray="0.777875 1" class="f2-splash-countdown-progress"></circle> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    ...
    - scrolling into view if needed
    - done scrolling
    - <div class="f2-splash-countdown-number">6</div> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <circle r="45" cx="50" cy="50" pathLength="1" stroke-dashoffset="0" stroke-dasharray="0.667375 1" class="f2-splash-countdown-progress"></circle> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div class="f2-splash-countdown-number">5</div> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="f2-splash-countdown-number">4</div> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <circle r="45" cx="50" cy="50" class="f2-splash-countdown-bg"></circle> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  2 × retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="f2-splash-countdown-number">3</div> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="f2-splash-countdown-number">2</div> from <div class="f2-start-splash-overlay">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
...
- generic [ref=e3]:
  - generic [ref=e5]:
    - generic [ref=e7] [cursor=pointer]:
      ...
      - 'heading "Desafío 1: Estándar" [level=1] [ref=e9]'
      - generic [ref=e10]:
        - generic [ref=e11]:
          - img [ref=e13]
    ...
    - main [ref=e61]:
      - generic [ref=e64]:
        - generic [ref=e66]: "Calcula mentalmente: 9 + 9 × 4"
        - generic [ref=e67]:
          - button "45" [ref=e68]
          - button "44" [ref=e69]
          - button "35" [ref=e70]
    ...
    - generic [ref=e74] [cursor=pointer]:
      ...
      - 'heading "Desafío 1: Estándar" [level=1] [ref=e76]'
      - generic [ref=e77]:
        - generic [ref=e78]:
          - generic [ref=e79]: 📚
        ...
        - generic [ref=e94]:
          ...
          - generic [ref=e97]: 25s / preguntas / pregunta
      - generic [ref=e98]:
        - img [ref=e99]
        - generic [ref=e102]: "2"
