...
Propósito: Desarrollar el razonamiento abstracto puro, el análisis combinatorio primario y el cálculo de posibilidades.
================================================================================
 │
 ├── [MÓDULO 1: Secuencias Lógicas] -> Tema: Progresiones aritméticas, geométricas e interpolación.
 │    ├── Nivel 1: [Progresiones aritméticas: hallar patrón de suma/resta constante] (Mecánica: Generador de series, sin tiempo)
 │    ├── Nivel 2: [Progresiones compuestas: multiplicación e intercaladas] (Mecánica: Multiplicadores en serie, Bucle Espejo)
 │    ├── Nivel 3: [Interpolación: deducir el término central faltante en una serie] (Mecánica: Completar casillas, fluidez)
 │    │
 │    ├── DESAFÍO 1: [Extensión de serie directa] (Mecánica: El Filtro, >80%)
 │    ├── DESAFÍO 2: [Series con dos reglas simultáneas] (Mecánica: La Trampa)
 │    └── DESAFÍO FINAL: [Problemas basados en el crecimiento exponencial de publicaciones en redes sociales] (Mecánica: El Candado, formato examen, ≥90%)
 │
 ├── [MÓDULO 2: Combinatoria Visual] -> Tema: Principio fundamental del conteo y combinaciones.
 │    ├── Nivel 1: [Diagramas de árbol y combinaciones por filas × columnas] (Mecánica: Constructor de árboles, sin tiempo)
 │    ├── Nivel 2: [Principio multiplicativo: opciones independientes sin repetición] (Mecánica: Matriz combinatoria, Bucle Espejo)
 │    ├── Nivel 3: [Introducción a divisores comunes para empacar grupos exactos] (Mecánica: Divisor de lotes, fluidez)
 │    │
 │    ├── DESAFÍO 1: [Multiplicación directa de opciones de uniformes] (Mecánica: El Filtro, >80%)
 │    ├── DESAFÍO 2: [Restricciones combinatorias excluyentes o patrones continuos de desbloqueo] (Mecánica: La Trampa)
 │    └── DESAFÍO FINAL: [Problemas oficiales de empaquetado de componentes tecnológicos en lotes mínimos] (Mecánica: El Candado, formato examen, ≥90%)
 │
 └── [MÓDULO 3: Probabilidad] -> Tema: Ley de Laplace y eventos aleatorios.
      ├── Nivel 1: [Clasificación determinística: evento seguro, posible, imposible] (Mecánica: Clasificador de tarjetas, sin tiempo)
      ├── Nivel 2: [Definición de Laplace: Casos Favorables / Casos Posibles en urnas] (Mecánica: Extracción de urnas, Bucle Espejo)
      ├── Nivel 3: [Análisis probabilístico y fracciones comparativas] (Mecánica: Comparador de tasas, fluidez)
      │
      ├── DESAFÍO 1: [Fracción de probabilidad simple con dados o monedas con tiempo] (Mecánica: El Filtro, >80%)
      ├── DESAFÍO 2: [Cambio de espacio muestral al extraer consecutivamente sin reposición de elementos] (Mecánica: La Trampa)
      └── DESAFÍO FINAL: [Problemas complejos basados en la presencia de sólidos de revolución mezclados en cajas] (Mecánica: El Candado, requiere ≥90% para abrir Fase 9)


================================================================================
[FASE 9: SIMULADOS PEDRO II]
Propósito: Entrenar en las condiciones formales, el formato, los límites de tiempo y la variedad de temas del examen real Pedro II.
================================================================================
 │
 ├── [MÓDULO 1: Simulados Cortos] -> Tema: Gestión estratégica del tiempo y repaso especializado por área.
 │    ├── Nivel 1: [Simulacro Temático: Bloques de 10 preguntas fijas por área específica] (Mecánica: Panel superior con Cronómetro de Arena Ámbar parpadeante, sin opciones de visualización inmediata de acierto, mapa numérico de navegación)
 │    ├── Nivel 2: [Simulacro Focalizado con Distractores: Bloques de 10 preguntas que combinan dos áreas mezcladas] (Mecánica: Panel superior interactivo, registro transaccional en tiempo real de desconexión, activación del botón de bandera amarilla 'Marcar para Revisar Después')
 │    ├── Nivel 3: [Maratón de Velocidad Temática: 10 preguntas seleccionadas de exámenes reales con reducción de tiempo por pregunta] (Mecánica: Navegación libre por saltos en mapa circular de preguntas, input puro en caliente guardado en servidor)
 │    │
 │    ├── DESAFÍO 1: [Filtro de Tiempo: Responder 8 de 10 correctas en un rango de tiempo competitivo] (Mecánica: El Filtro, >80% de precisión requerido)
 │    ├── DESAFÍO 2: [La Trampa de los Enunciados Largos: Problemas breves pero con alta carga narrativa distractora] (Mecánica: La Trampa, penalización oculta de tiempo de lectura)
 │    └── DESAFÍO FINAL: [Candado de Bloque Corto: Consolidación total de simulacro de 10 reactivos sin alternativas numéricas] (Mecánica: El Candado, requiere ≥90% de maestría)
 │
 ├── [MÓDULO 2: Simulados Completos] -> Tema: Resistencia matemática avanzada y adaptación formal al entorno de examen real.
 │    ├── Nivel 1: [Examen Tipo Completo Estándar: Reproducción idéntica en cantidad de reactivos y duración del Pedro II] (Mecánica: UI sobria y formal de vidrio templado, tipografía blanca mate, alternativas de selección múltiple apiladas verticalmente)
 │    ├── Nivel 2: [Simulacro Oficial Histórico: Carga integrada de la prueba completa de un año específico (ej. 2023 o 2024)] (Mecánica: Control estricto de tiempo por servidor, resplandor dorado sutil al seleccionar, ocultación absoluta de retroalimentación parcial)
 │    ├── Nivel 3: [Simulacro Transversal de Máxima Resistencia: Combinación parametrizada aleatoria que abarca el 100% de los temas de las Fases 1 a 8] (Mecánica: Guardado de estados en tiempo real ante desconexión accidental, botones Atrás/Siguiente integrados en barra de control inferior)
 │    │
 │    ├── DESAFÍO 1: [Corte de Resistencia Base: Finalizar el simulacro completo superando la barrera del 80% global] (Mecánica: El Filtro, doble confirmación modal antes del envío de datos)
 │    ├── DESAFÍO 2: [El Banco del Error Histórico: Examen estructurado solo con las preguntas que presentaron mayor índice de fallo en la historia del Pedro II] (Mecánica: La Trampa)
 │    └── DESAFÍO FINAL: [EXAMEN OFICIAL MAESTRO PEDRO II: Evaluación cúspide blindada de la plataforma] (Mecánica: El Candado, requiere ≥90% de aciertos para desbloquear la certificación final)
 │
 └── [MÓDULO 3: Revisión Dirigida y Tutoría IA] -> Tema: Autodiagnóstico, análisis reflexivo del error y nivelación dinámica.
      ├── Nivel 1: [Exploración de Resultados: Desglose analítico de puntuación mediante filtros selectivos] (Mecánica: Activación de barra de filtrado: Todas las preguntas / Solo Aciertos / Solo Errores)
      ├── Nivel 2: [Análisis de Respuestas: Contraste visual explícito del intento del alumno] (Mecánica: UI de revisión, resalte de la opción marcada por el niño en rojo y la alternativa correcta en verde)
      ├── Nivel 3: [Tutoría Pedro II con Inteligencia Artificial: Despliegue de guías paso a paso pedagógicas] (Mecánica: Ventana flotante interactiva con explicaciones analíticas dinámicas que detallan la lógica de solución oficial)
      │
      ├── DESAFÍO 1: [Filtro de Corrección: Resolver de forma exitosa los "ejercicios espejo" generados automáticamente a partir de las fallas del examen] (Mecánica: El Filtro, >80%)
      ├── DESAFÍO 2: [La Trampa Recurrente: Identificación y resolución de conceptos específicos que el alumno falló más de dos veces en la prueba] (Mecánica: La Trampa)
      └── DESAFÍO FINAL: [El Candado de la Graduación: Validación final de la erradicación del error pedagógico] (Mecánica: El Candado, requiere ≥90% para dar por concluida la Fase 9 de forma satisfactoria)
================================================================================
